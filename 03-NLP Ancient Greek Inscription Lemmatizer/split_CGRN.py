"""
New version of the original script split_CGRN.py from agile-complementary
Author: Silvia Stopponi
Date: 21/04/2023

Modified lines 38ss (removed only parentheses integrations, not integrated text)
"""
